 ...
 * Created on 14. Februar 2010, 22:00
 *
 * This file is part of JAMS (modified after SUN's BufferedReader 1.37 06/03/15)
...
public class BufferedFileReader extends Reader implements Serializable{
     ...
     * @param encoding The FieleInputStream's encoding
     */
    public BufferedFileReader(FileInputStream is, String encoding) {
        this(is, defaultCharBufferSize, encoding);
    }
    ...
    public void setNewLineCharsNumber(int newLineCharsNumber) {
        this.newLineCharsNumber = newLineCharsNumber;
    }
