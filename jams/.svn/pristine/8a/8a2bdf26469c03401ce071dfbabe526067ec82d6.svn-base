...
public class CmdLineParser {
    ...
    public static class UnknownOptionException extends OptionException {
        UnknownOptionException( String optionName ) {
            this(optionName, JAMS.i18n("Unknown_option_") + optionName + "'");
        }
    ...
    public static class UnknownSuboptionException
        ...
        UnknownSuboptionException( String option, char suboption ) {
            super(option, JAMS.i18n("Illegal_option:_")+suboption+JAMS.i18n("_in_")+option+"'");
    ...
    public static class NotFlagException extends UnknownOptionException {
        ...
        NotFlagException( String option, char unflaggish ) {
            super(option, JAMS.i18n("Illegal_option:_")+option+JAMS.i18n(",_")+
                  unflaggish+JAMS.i18n("'_requires_a_value"));
            notflag=unflaggish;
        }
    ...
    public static class IllegalOptionValueException extends OptionException {
        public IllegalOptionValueException( Option opt, String value ) {
            super(JAMS.i18n("Illegal_value_") + value + JAMS.i18n("_for_option_") +
    ...
    public static abstract class Option {
        ...
        private Option( String shortForm, String longForm, boolean wantsValue ) {
            if ( longForm == null )
                throw new IllegalArgumentException(JAMS.i18n("Null_longForm_not_allowed"));
     ...
     */
    @SuppressWarnings("unchecked") public final Option addOption( Option opt ) {
     ...
     */
    @SuppressWarnings("unchecked") public final Vector getOptionValues( Option option ) {
     ...
     * parsing options whose values might be locale-specific.
     */
    @SuppressWarnings("unchecked") public final void parse( String[] argv, Locale locale )
        throws IllegalOptionValueException, UnknownOptionException {
    ...
    @SuppressWarnings("unchecked") private void addValue(Option opt, Object value) {
