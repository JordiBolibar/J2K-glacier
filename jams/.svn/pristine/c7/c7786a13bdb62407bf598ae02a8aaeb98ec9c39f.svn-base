 ...
 * @author hbusch
 */
public class DViewerSample extends javax.swing.JFrame implements FeatureSelectionListener {

    SimpleFeatureLayer sf;
    SimpleFeatureAnnotationLayer sal;

    public static ResourceBundle resources = java.util.ResourceBundle.getBundle("resources/datareg");

    /** Creates new form ShapeExample */
    public DViewerSample() throws Exception {
        initComponents();
...
private void opacitySliderChanged(javax.swing.event.ChangeEvent evt) {
    ...
    public static void main(String args[]) throws Exception {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new DViewerSample().setVisible(true);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
