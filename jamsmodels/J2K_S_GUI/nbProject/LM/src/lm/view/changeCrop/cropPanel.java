...
public class cropPanel extends JFrame {
    ...
    public ArrayList<JLabel> addListenerToLabels(){
        return panel.getAllLabels();
    }
    ...
    public class panel extends JPanel{
        ...
        public ArrayList<JLabel> getAllLabels(){
            ArrayList<JLabel> a = new ArrayList();
            a.add(idcLabel);
            a.add(cpnmLabel);
            a.add(cropnameLabel);
            a.add(phuLabel);
        ...
        c=new Constraints(0,17,1,1);
        Add.setPreferredSize(Delete.getPreferredSize());
        c.anchor=GridBagConstraints.EAST;
        this.add(Add,c);

        c=new Constraints(1,17,1,1);
        ...
        idcLabel.setToolTipText("Land cover/plant classification: 1  warm season annual legume, 2  cold season annual legume, 3  perennial legume, 4  warm season annual, 5  cold season annual 6  perennial, 7  trees.");
        this.add(idcLabel,c);
