...
@Keywords
    ("Soilwater")
@SourceInfo
    ("$HeadURL: http://svn.javaforge.com/svn/oms/branches/oms3.prj.ceap/src/soilWater/J2KProcessLumpedSoilWater.java $")
@VersionInfo
    ("$Id: J2KProcessLumpedSoilWater.java 952 2010-02-11 19:55:02Z odavid $")
@License
    ("http://www.gnu.org/licenses/gpl-2.0.html")

 public class J2KProcessLumpedSoilWater  {
    ...
    @Out public double out_inRD1;
    
    @Description("HRU statevar RD2 inflow")
    // TODO READWRITE subst
    @In public double inRD2;
    @Out public double out_inRD2;
