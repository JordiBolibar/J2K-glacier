...
@Keywords
    ("Regionalization")
@SourceInfo
    ("$HeadURL: http://svn.javaforge.com/svn/oms/branches/oms3.prj.ceap/src/regionalization/IDWWeightCalculator.java $")
@VersionInfo
    ("$Id: IDWWeightCalculator.java 952 2010-02-11 19:55:02Z odavid $")
@License
