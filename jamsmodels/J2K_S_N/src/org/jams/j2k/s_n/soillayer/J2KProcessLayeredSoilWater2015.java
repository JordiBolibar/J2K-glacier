...
public class J2KProcessLayeredSoilWater2015 extends JAMSComponent {
...
//        netSnow.setValue(this.run_inSnow);
    ...
    private boolean calcMPSTranspiration(boolean debug, int hor) {
        ...
        /**
         * Transpiration from MPS if(deltaETP > 0){
         *
         * /** if enough water is available if(this.run_actMPS[hor] >
         * maxTrans){ this.run_actMPS[hor] = this.run_actMPS[hor] - maxTrans;
         * deltaETP = deltaETP - maxTrans; } /** storage is limiting ETP else{
         * deltaETP = deltaETP - this.run_actMPS[hor]; this.run_actMPS[hor] = 0;
         * } } *
         */
        /**
