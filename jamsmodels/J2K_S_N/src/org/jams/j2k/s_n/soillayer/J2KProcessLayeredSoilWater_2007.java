...
@JAMSComponentDescription(
        ...
        public class J2KProcessLayeredSoilWater_2007 extends JAMSComponent {
...
//        netSnow.setValue(this.run_inSnow);
    ...
    private boolean layer_diffusion(){
        ...
        resistance_h_h1[h] = (Math.log10(satbalance) * - kdiff_layer.getValue())*((layerdepth.getValue()[h] + layerdepth.getValue()[h+1])/200) ;
