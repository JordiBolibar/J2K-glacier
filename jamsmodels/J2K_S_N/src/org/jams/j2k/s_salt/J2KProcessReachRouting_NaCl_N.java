...
@JAMSComponentDescription(
        title="J2KProcessReachRouting_NaCl_N",
        author="c0krpe & Manfred Fink",
        description="Reach Routing of Water and Salt and Nitrogen to replace J2KProcessReachRouting",
        version="1.0"
        )
@VersionComments(entries = {
    @VersionComments.Entry(version = "1.0", comment = "Initial version")
})
        public class J2KProcessReachRouting_NaCl_N extends JAMSComponent {
    ...
    @JAMSVarDescription(
            ...
            public Attribute.Double DeepsinkNaCl;
...
//        int datumjul = time.get(time.DAY_OF_YEAR);
        ...
        double RD1DestIn, RD2DestIn, RG1DestIn, RG2DestIn, RD1DestIn_NaCl, RD2DestIn_NaCl, RG1DestIn_NaCl, RG2DestIn_NaCl, RD1DestIn_N, RD2DestIn_N, RG1DestIn_N, RG2DestIn_N;
        ...
        //calculation of NaCl-content in q_act_out
