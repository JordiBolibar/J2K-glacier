...
public class j2kpotCropGrowthsalt_new extends JAMSComponent {
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READWRITE,
            description = "Actual NaCl content in yield [kg N/ha]"
            )
...
// Optimal growth
    ...
    private boolean calc_lai() {
        ...
        this.lai_act = Math.max(this.lai_act,this.lai_min);
...
// Crop Yield
    ...
    private double calc_cropyield_ha_NaCl() {
    ...
    private boolean calc_residues_NaCl() {
        if ( this.idc == 7) {
