...
@JAMSComponentDescription(
        ...
        description="reach routing of water and energy to replace J2KProcessReachRouting",
        version="1.0_0",
        date="2012-01-31"
        )
        public class J2KProcessReachRoutingWQ_water_energy extends JAMSComponent {
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READWRITE,
            description = "relative part of RD1",
            unit = "-",
            lowerBound= 0,
            upperBound = 1
            )
            public JAMSDouble PartRD1;
    
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READWRITE,
            description = "relative part of RD2",
            unit = "-",
            lowerBound= 0,
            upperBound = 1
            )
            public JAMSDouble PartRD2;
    
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READWRITE,
            description = "relative part of RG1",
            unit = "-",
            lowerBound= 0,
            upperBound = 1
            )
            public JAMSDouble PartRG1;
    
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READWRITE,
            description = "relative part of RG2",
            unit = "-",
            lowerBound= 0,
            upperBound = 1
            )
            public JAMSDouble PartRG2;
...
//        int datumjul = time.get(time.DAY_OF_YEAR);
        ...
        PartRD1.setValue(RD1_part);
        PartRD2.setValue(RD2_part);
        PartRG1.setValue(RG1_part);
        PartRG2.setValue(RG2_part);
       ...
       //calculation of flow velocity
        ...
        QActTot.setValue(q_act_tot);
        QActOut.setValue(q_act_out);
