...
@JAMSComponentDescription(
        ...
        version="1.0_0",
        date="2013-03-29")
        public class J2KProcessSnow_IRSTEA_bidaily_global extends JAMSComponent {
...
// we want to have the snow accumulation at each timestep
	        ...
	        if((in_meltTempmax >= TRS) && (this.run_snowDepth > 0)){
	            this.calcMetamorphosis(in_meltTempmax, TRS, full_temp_fac, rain_fac, ground_fac, run_area, SAC, critDens);
	        }
	        if((in_meltTempmin >= TRS) && (this.run_snowDepth > 0)){
	            this.calcMetamorphosis(in_meltTempmin, TRS, full_temp_fac, rain_fac, ground_fac, run_area, SAC, critDens);
	        }
