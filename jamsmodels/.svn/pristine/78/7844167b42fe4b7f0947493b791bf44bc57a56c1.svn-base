/*
 * J2KProcessReachRoutingVeloc.java
...
@VersionComments(entries = {
    ...
    @VersionComments.Entry(version = "1.0_1", comment = "Added slopeAsProportion parameter to allow "
        ...
        public class J2KProcessReachRoutingVeloc extends JAMSComponent {
    ...
    @JAMSVarDescription(
            ...
            public Attribute.Double flowVelocity;
    ...
    public void run() {
        ...
        this.flowVelocity.setValue(flow_veloc);
