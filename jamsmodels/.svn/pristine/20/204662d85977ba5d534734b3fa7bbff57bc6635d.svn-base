 ...
 * @author c8fima
 */
public class Disaggregate_orun {
                    ...
                    while (jj < 6) {
                        if (i == 0) {
                            ...
                            if (hourdi < 10) {
                                ...
                                System.out.println("more than 6 hours!");
                                //System.exit(0);
                            }
    ...
    public static void main(String[] args) {
        Disaggregate_orun Precipi = new Disaggregate_orun();

        Precipi.convert("C:\\LUCCI\\Delta_t\\Data\\orun_6h.txt", "C:\\LUCCI\\Delta_t\\Data\\orun_1h.txt");
    }
}
