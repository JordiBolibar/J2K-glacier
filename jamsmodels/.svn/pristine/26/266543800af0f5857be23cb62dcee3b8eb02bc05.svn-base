...
@JAMSComponentDescription(
        title="J2KProcessMultiReachRouting_N",
        author="c0krpe & Manfred Fink",
...
@VersionComments(entries = {
    ...
    @VersionComments.Entry(version = "1.0_1", comment = "Added slopeAsProportion parameter to allow "
        ...
        public class J2KProcessReachRouting_N_musle extends JAMSComponent {
...
//        int datumjul = time.get(time.DAY_OF_YEAR);
        ...
        double RD1DestIn, SedDestIn, RD2DestIn, RG1DestIn, RG2DestIn, RD1DestIn_N, RD2DestIn_N, RG1DestIn_N, RG2DestIn_N;
