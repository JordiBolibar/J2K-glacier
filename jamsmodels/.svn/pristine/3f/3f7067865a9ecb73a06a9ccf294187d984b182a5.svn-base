...
@JAMSComponentDescription(
        ...
        public class J2KProcessLayeredSoilWaterAnnika extends JAMSComponent {
    ...
    @JAMSVarDescription(
      ...
      @JAMSVarDescription(
    access = JAMSVarDescription.AccessType.WRITE,
            description = "HRU RD1 outflow"
            )
            public Attribute.Double out_outRD1;
    ...
    @JAMSVarDescription(
     ...
     @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.WRITE,
            description = "HRU layersum of statevar RD2 outflow"
            )
            public Attribute.Double sRD2out;
...
/*    @JAMSVarDescription(
    ...
    double  run_actDPS, run_satSoil1, run_inRain, run_inSnow,
            ...
            run_inRD1, soilSatMps, soilSatLps, soilActMps, soilActLps, soilMaxMps, soilMaxLps, run_outRD1, run_genRD1, lowpart, top_satsoil, run_sRD2out;
    ...
    public void run() {
        ...
        for(int h = 0; h < this.nhor; h++){
            ...
            run_sRD2out = run_outRD2[h] + run_sRD2out;
...
//                System.out.println("test");
        ...
        sRD2out.setValue(this.run_sRD2out);
...
//        netSnow.setValue(this.run_inSnow);
        ...
        out_outRD1.setValue(this.run_outRD1);
