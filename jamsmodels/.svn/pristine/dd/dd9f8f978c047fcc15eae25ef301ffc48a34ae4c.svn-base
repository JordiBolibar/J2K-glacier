...
@JAMSComponentDescription(
        ...
        author="Peter Krause, DPS modified by Markus Meinhardt",
        description="Calculates soil water balance for each spatial modelling unit; depression storage on slopes >2° is 50% of the normal dep. storage",
        version="1.0_0",
        date="2011-05-30")
    ...
    private double calcDirectRunoff(){
        ...
        if(this.run_actDPS > 0){
            ...
            /** depression storage on slopes >2° is 50% of the normal dep. storage */
            if(this.run_slope > 2){
