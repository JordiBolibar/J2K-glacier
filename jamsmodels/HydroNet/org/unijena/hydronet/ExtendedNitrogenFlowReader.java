...
public class ExtendedNitrogenFlowReader extends JAMSComponent {
	...
	for (int i=0;i<N+1;i++) {
	    ...
	    for (int i=0;i<N;i++) {
	        interflow += field_fd[i].getDouble("sinterflowN_2000") + field_fd[i].getDouble("SurfaceN_2000") +
                        field_fd[i].getDouble("sum_NH4")+  field_fd[i].getDouble("sum_activN") + field_fd[i].getDouble("sum_residueN");
